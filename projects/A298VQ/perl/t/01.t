...
is( $float_fsm->validate('3.14e-2'), 'OK 3.14e-2', 'validate 3.14e-2  = OK 3.14e-2' );
is( $float_fsm->validate('1e2'),     'OK 1e+2',    'validate 1e+2     = OK 1e+2' );
is( $float_fsm->validate('2.4E-5'),  'OK 2.4e-5',  'validate 2.4e-5   = OK 2.4e-5' );
is( $float_fsm->validate('.1e+3'),   'OK 0.1e+3',  'validate 0.1e+3   = OK 0.1e+3' );
